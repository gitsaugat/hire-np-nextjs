...
export default function DashboardHeader({ companyName = "Novatech Solutions" }) {
  return (
    <header className="h-20 bg-white border-b border-[#f1f5f9] flex items-center justify-between px-8 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 pl-6 border-l border-[#f1f5f9]">
          ...
          <div className="w-10 h-10 bg-teal/10 rounded-xl flex items-center justify-center text-teal border border-teal/20">
            <User size={20} />
          </div>
        </div>
      </div>
